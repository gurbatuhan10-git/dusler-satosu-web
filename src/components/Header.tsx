...
const navItems = [
  { label: "Bati Atasehir", href: "/kampusler/bati-atasehir" },
  { label: "Dogu Atasehir", href: "/kampusler/dogu-atasehir" },
  { label: "Koc Universitesi", href: "/kampusler/koc-universitesi" },
];
