    ...
    <section className="section-padding bg-gradient-to-br from-brand-koyu to-brand-koyu/95 text-white">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {data.stats.map((stat, i) => (
            <div key={i} className="text-center">
              <div className="font-display font-bold text-4xl md:text-5xl text-brand-pembe">
                {stat.value}
              </div>
        ...
        <div className="text-center mb-10">
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 text-brand-pembe text-sm font-medium rounded-full">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {data.testimonials.map((t, i) => (
            ...
            >
              <Quote className="w-8 h-8 text-brand-pembe/40 mb-4" />
              <p className="text-gray-300 leading-relaxed mb-4 italic">
                &ldquo;{t.text}&rdquo;
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-brand-pembe/20 flex items-center justify-center text-brand-pembe font-bold text-sm">
                  {t.author.charAt(0)}
                </div>
                <div>
        ...
        {data.familyConsulting && (
          <div className="mt-12 max-w-3xl mx-auto text-center">
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
              <h3 className="font-display font-semibold text-lg text-brand-pembe mb-2">
